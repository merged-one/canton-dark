...
const mode = process.argv[2] ?? "phase1-ready";
...
if (!response.ok) {
  console.error(`Failed to seed Phase 1 demo state from ${apiOrigin}.`);
...
console.log("Phase 1 demo state ready");
...
console.log(`Dealer: ${dealerOrigin}/${query(status.dealerId)}`);
